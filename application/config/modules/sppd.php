...
$config['module']['sppd']['permission']  = array(
    'index'   => 'ADMIN,SUPER ADMIN,PIC STAFF,PIC STAFF JKT,CHIEF OPERATION OFFICER',
    'create'  => 'ADMIN,SUPER ADMIN,PIC STAFF,PIC STAFF JKT',
    'import'  => 'ADMIN,SUPER ADMIN,PIC STAFF,PIC STAFF JKT',
    'print'   => 'ADMIN,SUPER ADMIN,PIC STAFF,PIC STAFF JKT,CHIEF OPERATION OFFICER',
    'info'    => 'ADMIN,SUPER ADMIN,PIC STAFF,PIC STAFF JKT,CHIEF OPERATION OFFICER',
