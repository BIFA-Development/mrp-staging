...
$config['module']['business_trip_request']['permission']  = array(
    'index'   => 'ADMIN,SUPER ADMIN,PIC STAFF,PIC STAFF JKT,CHIEF OPERATION OFFICER,HEAD OF SCHOOL',
    'create'  => 'ADMIN,SUPER ADMIN,PIC STAFF,PIC STAFF JKT',
    'import'  => 'ADMIN,SUPER ADMIN,PIC STAFF,PIC STAFF JKT',
    'print'   => 'ADMIN,SUPER ADMIN,PIC STAFF,CHIEF OPERATION OFFICER,PIC STAFF JKT',
    'info'    => 'ADMIN,SUPER ADMIN,PIC STAFF,CHIEF OPERATION OFFICER,HEAD OF SCHOOL,PIC STAFF JKT',
    'save'    => 'ADMIN,SUPER ADMIN,PIC STAFF,PIC STAFF JKT',
    'delete'  => 'ADMIN,SUPER ADMIN,PIC STAFF,PIC STAFF JKT',
