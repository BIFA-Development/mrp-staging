            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-head style-primary-dark">
                        <header>Employee's Leave Periode Kontrak : <?=$periodeContractActive?></header>
    ...
    <div class="offcanvas-body no-padding">
        <ul class="list ">
            <div class="form force-padding">
                ...
                <div class="form-group">
                    <label for="filter_warehouse">Periode Kontrak</label>
                    <select class="form-control input-sm filter_dropdown" data-column="2" id="filter_kontrak">
                        <option value="">Not filtered</option>
                        <?php foreach (getContractByEmployeeNumber($entity['employee_number']) as $contract) : ?>
                        <option value="<?= $contract['id']; ?>" <?php if($kontrak_active['id']==$contract['id']):echo 'selected'; endif;?>>
                        <?= print_string($contract['contract_number']) ?> (<?= print_date($contract['start_date']) ?> sd <?= print_date($contract['end_date']) ?>)
                        </option>
                        <?php endforeach; ?>
                    </select>
                </div>
